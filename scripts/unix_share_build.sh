...
function setup_var() {
    ...
    elif [ "$1" == "2023.8-dev" ] ; then
        CUBIT_PATH="/opt/Coreform-Cubit-2023.8"
    else
...
function linux_setup_cubit() {
    ...
    if [ "$1" == "2021.3" ] || [ "$1" == "2021.4" ] || [ "$1" == "2021.5" ] || [ "$1" == "2021.11" ] || [ "$1" == "2022.4" ] || [ "$1" == "2023.8-dev" ] ; then
	    return
    fi
